import {
  ...
  const CollectionForm = () => {
    ...
    const getCollectionByCollectionId = () => {
      axios({
        ...
        setCashInHand(string(result.data.plantReadingDto.cashInHand))
  ...
  let cashhand=parseInt(resultCoin)+parseInt(resultRecharge)+parseInt(prevBal)-parseInt(newBal)-parseInt(watSal)
    return (
      <ScrollView>
        <View>
          <Header />
          ...
          <View style={Styles.container}>
            <SafeAreaView>
              ...
              <TextInput
                ...
                style={Styles.inp3}
              />
               <Text>Cash In Hand = {cashhand} </Text>
              <TextInput
  ...
  //   const [waterManSalary, setWaterManSalary] = useState();
  //   const [cashInHand, setCashInHand] = useState();
  // const[resultVolumeReading,setresultVolumeReading]=useState()
  // const[resultRecharge,setResultRecharge]= useState()
  ...
  //   var c=(currentVolumeReading-previousVolumeReading);
    
  //   var currentRecharge=currentRechargeReading;
  //   var previousRecharge=previousRechargeReading;
    
  //   var currentCoin=currentCoinReading;
  //   var previousCoin=previousCoinReading;
  
  //   var prevBal=previousBalance;
  //   var newBal=newBalance;
    
  //   var watSal=waterManSalary
    
  //   var cashhand=parseInt(currentCoinReading-previousCoinReading)+parseInt(currentRechargeReading-previousRechargeReading)+parseInt(prevBal)-parseInt(newBal)-parseInt(watSal)
   
  //   setresultVolumeReading((c/20)*5)
  //   setResultRecharge(currentRechargeReading-previousRechargeReading)
  //   setResultCoin(currentCoinReading-previousCoinReading)
  //   setCashInHand(cashhand)
  // }
  //   return (
  //     <ScrollView>
  //       <View>
  ...
  //               style={Styles.inp3}
  //             />
  //              <Text>Cash In Hand = {cashInHand} </Text>
  //             {/* <TextInput
  //               placeholder="Cash In Hand"
  //               keyboardType="numeric"
  //               value={cashInHand}
