...
const MaterialAssign = () => {
  ...
  const getMaterialAssign = () => {
    axios({
      method: "GET",
      url: `${BaseUrl}/materialassign/v1/getAssignedMaterialsByPagination/{pageNumber}/{pageSize}/{technicianId}?pageNumber=${pageNumber}&pageSize=${pageSize}&technicianId=${techId}`,
      headers: {
