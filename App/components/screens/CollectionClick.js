...
const CollectionClick = () => {
  ...
  return (
    <View>
      ...
      <Text style={{ fontSize: 30, marginBottom: 10, zIndex: -1 }}>Collection Tasks</Text>
      <View >
      <Text style={Styles.text}>Date: {serviceDate}</Text>
      <Text style={Styles.text} >previousVolumeReading: {previousVolumeReading}</Text>
      <Text style={Styles.text} >currentVolumeReading: {currentVolumeReading}</Text>
      <Text style={Styles.text} >previousRechargeReading: {previousRechargeReading}</Text>
      <Text style={Styles.text} >currentRechargeReading: {currentRechargeReading}</Text>
      <Text style={Styles.text} >previousCoinReading: {previousCoinReading}</Text>
      <Text style={Styles.text} >currentCoinReading: {currentCoinReading}</Text>
      ...
      <Image style={{width:130,height:130, borderWidth:2,borderColor:"black"}} source={(photo===null || photo==="")? require("../../assets/noImage.jpg") : photo}  />
      </View>
      <Text></Text>
