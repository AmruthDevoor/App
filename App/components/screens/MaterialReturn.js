...
const MaterialReturn = () => {
  ...
  const getMaterialReturn = () => {
    axios({
      method: "GET",
      url:  `${BaseUrl}/materialreturn/v1/getReturnedMaterialsByPagination/{pageNumber}/{pageSize}/{technicianId}?pageNumber=${pageNumber}&pageSize=${pageSize}&technicianId=${techId}`,
      headers: {
